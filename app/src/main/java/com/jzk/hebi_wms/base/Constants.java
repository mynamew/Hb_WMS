...
public class Constants {
     ...
     * base url
     */
    public static final String BASE_URL = "http://192.168.0.35:8101/";
//    public static final String BASE_URL = "http://192.168.0.39:8066/";
    ...
    public static  final String PERMISSION_STOCKIN_FINISH_GOODS="Pages.WPDA.PrdInstock";//成品入库
    public static  final String PERMISSION_STOCKIN_OUT_RETURN="Pages.WPDA.WWReturn";//委外退料
    public static  final String PERMISSION_STOCKIN_PRODUCTION_PUTAWAY="Pages.WPDA.PrdReturn";//生产退料
    public static  final String PERMISSION_STOCKIN_SALE_RETURN="Pages.WPDA.SalesReturn";//销售退货
    public static  final String PERMISSION_STOCKIN_OUT_PO="Pages.WPDA.OutsourcePO";//委外单
    ...
    public static  final String PERMISSION_STOCKOUT_APPLY_CREATE="Pages.WPDA.ApplyCreate";//申请制单
    public static  final String PERMISSION_STOCKOUT_APPLY_SAELE_PICK="Pages.SalesPick";//销售拣货
    public static  final String PERMISSION_STOCKOUT_APPLY_SEND_PICK="Pages.WPDA.DeliveryPick";//发货拣货
    public static  final String PERMISSION_STOCKOUT_APPLY_ALLOT_PICK="Pages.TransferPick";//调拨拣货

    public static  final String PERMISSION_STOCKIN_WORK="Pages.WPDA.StockIn";//库内作业
    ...
    public static  final String PERMISSION_STOCKIN_WORK_CHECK="Pages.WPDA.Check";//盘点

    public static  final String PERMISSION_QUERY="Pages.WPDA.ReportQuery";//综合查询
    public static  final String PERMISSION_QUERY_REPORT_QUERY="Pages.WPDA.ReportQuery.StockSummary";//报表查询
    public static  final String PERMISSION_QUERY_TODAY_IN_DETIAL="Pages.WPDA.ReportQuery.InStockDetailSummary";//今日入库明细关系
    public static  final String PERMISSION_QUERY_TODAY_OUT_DETIAL="Pages.WPDA.ReportQuery.OutStockDetailSummary";//今日出库明细关系
    public static  final String PERMISSION_QUERY_SN_FORM="Pages.WPDA.ReportQuery.BarcodeTraces";//SN追溯
    public static  final String PERMISSION_QUERY_BARCODE="Pages.WPDA.ReportQuery.BillBarcode";//单据条码
    public static  final String PERMISSION_QUERY_OUTSTOCK_RECORD="Pages.WPDA.ReportQuery.OutStockDetail";//出库记录
    public static  final String PERMISSION_QUERY_INSTOCK_RECORD="Pages.WPDA.ReportQuery.InStockDetail";//入库记录
    public static  final String PERMISSION_QUERY_INSTOCK_COUNT="Pages.WPDA.ReportQuery.InStockDayStatistics";//入库统计
    public static  final String PERMISSION_QUERY_OUTSTOCK_COUNT="Pages.WPDA.ReportQuery.OutStockDayStatistics";//出库统计
    /***********
     * 跳转 传递的相关字段
     *********************************************************************************************/
    /***********
   ...
   public static  final String STOCKIN_BILLID="stockin_billid";
    ...
    public static final int EDITTEXT_BILLCODE= 5307;//单据编号
    public static final int EDITTEXT_BILLDATE = 5308;//单据日期
    public static final int EDITTEXT_MATERIALCODE = 5309;//物料编码
}

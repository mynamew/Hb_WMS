package com.jzk.hebi_wms.http.subscriber;
...
import com.jzk.hebi_wms.data.HttpResultBean;
...
import static com.jzk.hebi_wms.http.exception.ApiException.CODE_REQUEST_SUCCESS_EXCEPTION;
    ...
    public void onError(Throwable e) {
        ...
        if (e instanceof CompositeException) {
            ...
            try {
                ...
                LogUitls.e("抛出异常" + ((HttpException) e).message());
                mOnResultListener.onError(SERVER_TIMEOUT_EXCEPTION);
